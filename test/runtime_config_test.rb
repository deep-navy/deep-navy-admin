...
abort "callback is not derived from the deployed admin site" unless runtime.fetch("cognito_callback_url") == "https://deep-navy.github.io/deep-navy-admin/auth/callback/"
abort "logout URL is not the deployed admin root" unless runtime.fetch("cognito_logout_url") == "https://deep-navy.github.io/deep-navy-admin/"
abort "unexpected site URL" unless configuration.fetch("url") == "https://deep-navy.github.io"
abort "unexpected site base path" unless configuration.fetch("baseurl") == "/deep-navy-admin"
abort "admin session ceiling changed" unless runtime.fetch("session_max_age_seconds") == 900

invalid_cases = {
  "CSP-like API injection" => { "ADMIN_API_BASE_URL" => "https://api.dev.deep.navy; script-src *" },
  "site URL credentials" => { "ADMIN_URL" => "https://user@deep-navy.github.io/deep-navy-admin" },
  "site URL query" => { "ADMIN_URL" => "https://deep-navy.github.io/deep-navy-admin?preview=true" },
  "trailing project slash" => { "ADMIN_URL" => "https://deep-navy.github.io/deep-navy-admin/" },
